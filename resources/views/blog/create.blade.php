                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data" id="blogCreateForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control-lg border-2 @error('title') is-invalid @enderror" placeholder="Enter Your Blog title" value="{{ old('title') }}" style="border-radius: 12px; height: 52px; border-color: #e5cbd6;">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="blog_type" id="blog_type" class="form-select form-select-lg border-2 @error('blog_type') is-invalid @enderror" style="border-radius: 12px; height: 52px; border-color: #e5cbd6; appearance: none; background-image: url('data:image/svg+xml;utf8,<svg xmlns=&quot;http://www.w3.org/2000/svg&quot; width=&quot;24&quot; height=&quot;24&quot; viewBox=&quot;0 0 24 24&quot; fill=&quot;none&quot; stroke=&quot;%23ff4757&quot; stroke-width=&quot;2&quot; stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot;><polyline points=&quot;6 9 12 15 18 9&quot;></polyline></svg>'); background-repeat: no-repeat; background-position: right 15px center; background-size: 16px;">
                                ...
                                <option value="Event" {{ old('blog_type') === 'Event' ? 'selected' : '' }}>Event</option>
                                <option value="Opinion" {{ old('blog_type') === 'Opinion' ? 'selected' : '' }}>Opinion</option>
                                <option value="Other" {{ old('blog_type') === 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('blog_type')
                                <div class="text-danger small mt-1 fw-semibold" style="color: #c92f54 !important;">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="8" class="form-control border-2 @error('description') is-invalid @enderror" placeholder="Enter Your Blog description" style="border-radius: 12px; resize: vertical; border-color: #e5cbd6;">{{ old('description') }}</textarea>
