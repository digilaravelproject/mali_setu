                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if($user->cast_certificate)
                                                <div class="mb-2">
                                                    <a href="{{ asset('storage/' . $user->cast_certificate) }}" target="_blank" class="btn btn-outline-info btn-sm">
                                                        <i class="fas fa-file-pdf me-1"></i> View Current Certificate
                                                    </a>
                                                </div>
                                            @endif
                                            ...
                                            <small class="text-muted small">Upload PDF or image to replace current certificate (max 5MB)</small>
                                        </div>
