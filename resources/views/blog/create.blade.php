                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data" id="blogCreateForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="form-control form-control-lg border-2" placeholder="e.g. My Experience Visiting the Community Cultural Center" value="{{ old('title') }}" required style="border-radius: 12px;">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="10" class="form-control border-2" placeholder="Start writing your article here..." required style="border-radius: 12px; resize: vertical;">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tags" id="tags" class="form-control border-2" placeholder="e.g. cultural, event, community, stories" value="{{ old('tags') }}" style="border-radius: 12px;">
                            <div class="form-text small">Enter comma-separated values (e.g. news, events, guides). Tags help users filter articles.</div>
                        </div>

                        <!-- Media File -->
                        <div class="mb-4">
                            <label for="media" class="form-label fw-semibold text-secondary font-weight-bold">Attach Media (Image / Video)</label>
                            <div class="media-upload-dropzone border-2 border-dashed p-4 text-center bg-light rounded-4 position-relative" style="cursor: pointer; border-color: rgba(var(--primary-rgb), 0.3) !important;">
                                ...
                                <div id="dropzoneContent">
                                    ...
                                    <h6 class="fw-bold mb-1">Drag & drop or click to upload file</h6>
