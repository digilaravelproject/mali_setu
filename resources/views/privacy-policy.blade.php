...
<div class="container flex-grow-1 d-flex align-items-center">
    <div class="page-card text-start">
        <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill mb-3 fw-bold text-uppercase"><i class="fa-solid fa-shield-halved me-1"></i> Privacy Center</span>
        <h2 class="fw-extrabold text-dark mb-4">{{ $page->page_name ?? 'Privacy Policy' }}</h2>
        ...
        <div class="row g-4 text-start">
            ...
            <div class="col-md-2 offset-lg-1">
                ...
                <ul class="list-unstyled opacity-75">
                    <li class="mb-2"><a href="{{ url('/#business-how') }}" class="text-white text-decoration-none hover-text-primary">Business Directory</a></li>
