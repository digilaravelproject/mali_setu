...
<head>
    ...
    <title>{{ $page->page_name ?? 'Contact Us — Mali Setu' }}</title>
    <meta name="description" content="Contact Mali Setu support for any community or account queries.">
...
<div class="container flex-grow-1 d-flex align-items-center">
    <div class="page-card text-start">
        <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill mb-3 fw-bold text-uppercase"><i class="fa-solid fa-envelope me-1"></i> Support Hub</span>
        <h2 class="fw-extrabold text-dark mb-4">{{ $page->page_name ?? 'Contact Support' }}</h2>
