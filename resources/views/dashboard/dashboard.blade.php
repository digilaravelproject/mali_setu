                        ...
                        @foreach($banners as $index => $banner)
                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}" data-bs-interval="4500">
                                <div class="banner-slide-wrapper position-relative w-100 overflow-hidden">
                                    @php
                                        $mobileBannerPath = $banner->image_path ?: $banner->web_image_path;
                                    @endphp
                                    ...
                                    <img src="{{ asset('storage/' . $mobileBannerPath) }}" class="d-md-none w-100 h-100" style="object-fit: fill;" alt="{{ $banner->title }}">
