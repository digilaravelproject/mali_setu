                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <button class="btn btn-outline-success btn-sm rounded-3" onclick="toggleBusinessSection('console')">
                                                <i class="fa-solid fa-eye me-1"></i> View Console
                                            </button>
                                            <a href="{{ route('dashboard.business.edit') }}" class="btn btn-outline-primary btn-sm rounded-3">
            ...
            @if($user->is_business)
                <div id="business-console-section" style="display: none;">
                    <div class="d-flex align-items-center justify-content-between mb-4 border-bottom pb-3">
                        ...
                        <div>
                            <a href="{{ route('dashboard.business.show', $user->business->id) }}" class="btn btn-outline-primary btn-sm rounded-3" target="_blank">
