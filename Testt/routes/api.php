...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('payment')->group(function () {
        ...
        Route::post('create-order/business', [PaymentController::class, 'createBusinessOrder']);
        Route::post('create-order/matrimony', [PaymentController::class, 'createMatrimonyOrder']);
