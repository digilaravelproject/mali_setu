...
@php
    ...
    $titlesList = ['Mr.', 'Mrs.', 'Ms.', 'Dr.', 'Prof.'];
    if (count($parts) > 1 && (in_array(trim($parts[0]), $titlesList) || str_ends_with(trim($parts[0]), '.'))) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select class="form-select @error('title') is-invalid @enderror" id="title" name="title" required>
                                                    ...
                                                    <option value="Mr." {{ old('title', $title) == 'Mr.' ? 'selected' : '' }}>Mr.</option>
                                                    <option value="Mrs." {{ old('title', $title) == 'Mrs.' ? 'selected' : '' }}>Mrs.</option>
                                                    <option value="Ms." {{ old('title', $title) == 'Ms.' ? 'selected' : '' }}>Ms.</option>
                                                    <option value="Dr." {{ old('title', $title) == 'Dr.' ? 'selected' : '' }}>Dr.</option>
                                                    <option value="Prof." {{ old('title', $title) == 'Prof.' ? 'selected' : '' }}>Prof.</option>
                                                </select>
                                            </div>
                                            <div class="col-md-9 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('first_name') is-invalid @enderror" 
                                                       id="first_name" name="first_name" value="{{ old('first_name', $first_name) }}" required placeholder="John">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('middle_name') is-invalid @enderror" 
                                                       id="middle_name" name="middle_name" value="{{ old('middle_name', $middle_name) }}" placeholder="Barry">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="last_name" class="form-label font-weight-bold small">Last Name <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control @error('last_name') is-invalid @enderror" 
                                                       id="last_name" name="last_name" value="{{ old('last_name', $last_name) }}" required placeholder="Doe">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('respected_person_name') is-invalid @enderror"
                                                   id="respected_person_name" name="respected_person_name" value="{{ old('respected_person_name', $user->respected_person_name) }}" placeholder="Enter respected person's name">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="tel" class="form-control @error('respected_person_mobile_number') is-invalid @enderror"
                                                   id="respected_person_mobile_number" name="respected_person_mobile_number" value="{{ old('respected_person_mobile_number', $user->respected_person_mobile_number) }}" inputmode="numeric" pattern="[0-9]{10}" maxlength="10" placeholder="10-digit mobile number">
                                        </div>
