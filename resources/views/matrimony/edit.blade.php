            ...
            <div class="form-section" id="section-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="hidden" name="latitude" id="matrimonyLatitudeInput" value="{{ old('latitude', $ld['latitude'] ?? $user->latitude ?? '') }}">
                        <input type="hidden" name="longitude" id="matrimonyLongitudeInput" value="{{ old('longitude', $ld['longitude'] ?? $user->longitude ?? '') }}">
                    </div>
