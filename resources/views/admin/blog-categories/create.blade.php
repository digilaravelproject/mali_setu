...
<div class="content-area">
    ...
    <div class="card border-0 shadow-sm col-lg-8 mx-auto" style="border-radius:16px;">
        <div class="card-header bg-white py-3">
            <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-tags text-primary me-2"></i>Create Blog Category</h5>
        </div>
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.blog-categories.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="Enter category name (e.g. Agriculture, Education, Tech)" value="{{ old('name') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="4" class="form-control" placeholder="Provide a brief description detailing the purpose of this category...">{{ old('description') }}</textarea>
                </div>
